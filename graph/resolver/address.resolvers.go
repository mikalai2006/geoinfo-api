...
func (r *addressResolver) Address(ctx context.Context, obj *model.Address) (interface{}, error) {
	return obj.Address, nil
}

// Props is the resolver for the props field.
func (r *addressResolver) Props(ctx context.Context, obj *model.Address) (interface{}, error) {
