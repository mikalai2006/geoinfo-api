...
func (r *nodedataAuditResolver) Value(ctx context.Context, obj *model.NodedataAudit) (interface{}, error) {
	return obj.Value, nil
}

// Props is the resolver for the props field.
func (r *nodedataAuditResolver) Props(ctx context.Context, obj *model.NodedataAudit) (interface{}, error) {
